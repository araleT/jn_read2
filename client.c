...
int main(int argc, char *argv[])
{
	...
	setPlayerNum(my_playernum); // 出力ファイル名を区別ためにプレイヤー番号をセットする
	...
	while (whole_gameend_flag == 0)
	{
		...
		{									 //1ゲームが終わるまでの繰り返し
			...
			// printf("mynum : %d" NL , ba_cards[5][2]);
			// printf("player: %d" NL , ba_cards[5][3]);
